...
class TestNotificationChannelRequest(BaseModel):
    ...
    mask_token: str = "******"
    title: str = Field(default="Kiểm tra thông báo DSA", min_length=1, max_length=80)
    content: str = Field(default="Đây là thông báo kiểm tra từ trang cài đặt Web DSA.", min_length=1, max_length=1000)
