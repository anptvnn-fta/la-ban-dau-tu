...
1. **Insider / Major Shareholder Activity** — sell-downs (bán ròng cổ đông lớn), pledges
2. **Earnings Warnings** — pre-loss, downward revisions (cảnh báo lợi nhuận, lợi nhuận đảo chiều)
3. **Regulatory** — penalties, investigations, violations (xử phạt quản lý, bị điều tra)
4. **Industry Policy** — headwinds, sector crackdowns
5. **Lock-up Expirations** — large block unlocks within 30 days (mở room cổ phiếu hạn chế)
