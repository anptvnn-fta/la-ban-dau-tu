...
# Vietnam tickers: 2-3 uppercase letters + .VN suffix (e.g. FPT.VN, VCB.VN).
# Handled by a dedicated regex because the base is alphabetic (not digits),
# so the digit-based _strip_exchange_suffix path does not apply.
_VN_SUFFIX_RE = re.compile(r"^[A-Z]{2,3}\.VN$")
